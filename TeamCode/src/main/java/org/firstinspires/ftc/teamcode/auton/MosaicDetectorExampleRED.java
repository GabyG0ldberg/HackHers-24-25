    ...
    public static class MosaicDeterminationPipeline extends OpenCvPipeline
    {
       ...
       //            static final Point REGION3_TOPLEFT_ANCHOR_POINT = new Point(253,98);
        ...
        public void init(Mat firstFrame)
        {
             ...
             */
            region1_Cr = frame.submat(new Rect(region1_pointA, region1_pointB));
            region2_Cr = frame.submat(new Rect(region2_pointA, region2_pointB));
            region3_Cr = frame.submat(new Rect(region3_pointA, region3_pointB));
        }
